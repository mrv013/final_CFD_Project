...
dt = 0.01;end_time = 0.04;nt = Int64(end_time/dt)
...
time=[0.25, 0.5, 0.75,1].*end_time

# ╔═╡ 2f5b3487-c3f1-4164-9914-8750671b7cb4


# ╔═╡ cf5c10c1-3e09-4a98-b088-5db98583df78
res_upwind_t=[generate_all_time_for_1_line(n,L_y,L_x,end_time,dti,alfa,y0,x0,gamma,x_line_want_L) for dti in t_Range ]

# ╔═╡ 05f57bcf-b9a6-49af-8844-56943d2ce285
plot_t_seris(time, t_Range, res_upwind_t, x_want_t, nRange1,"method_name")
...
generate_all_time_for_1_line(n,L_y,L_x,dt,alfa,y0,x0,nt,gamma,x_line_want_L)
